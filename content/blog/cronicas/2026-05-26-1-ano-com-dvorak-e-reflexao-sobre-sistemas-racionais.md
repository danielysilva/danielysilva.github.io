---
layout: blog
title: "1 ano com Dvorak e reflexão sobre sistemas racionais"
date: 2026-05-26
author: Daniely Silva
categories: ["Crônicas"]
tags: ["tecnologia", "reflexões"]
summary:
featured_image: "/img/blog/dvorak3.jpg"
featured_image_title: "Dvorak sobre Qwerty."
featured_image_alt: "Teclado branco coberto com papeis amarelos com outra disposição de letras."
draft: false
---
Faz quase um ano que comecei a usar Dvorak. Lembro-me que tinha acabado de sair de férias e a viagem interrompeu o fluxo de aprendizado; àquela altura, escolhera o [curso de Justin Chang](https://dvorak.justinpchang.com/) para aprender o novo teclado.
...
Esteve fora de cogitação migrar 100% para o Dvorak. Não quero desaprender o leiaute tradicional, pois ainda o uso no trabalho, na faculdade e na minha [Olivetti Lettera 22](/blog/cronicas/2025-03-12-sob-a-escrita/). Independente da dificuldade em digitar, todo texto precisa ser revisado mais de uma vez, o que me mostra que devo dedicar mais atenção a essa etapa essencial da escrita.
...
Em 2005, enquanto co-participava da adaptação do Dvorak ao português e criava o Nativo, o desenvolvedor [Ari Caldeira](https://github.com/aricaldeira) se movimentou em busca de dados concretos sobre a eficiência do Dvorak. É o que ele relata numa discussão no extinto fórum de [Nando Florestan](https://dev.nando.audio/pages/teclado.html?highlight=nativo):
...
Quando li que o Dvorak tem um ritmo próprio, pareceu-me uma [ideia de Chirico](https://blog.ayom.media/ideiasdechirico/como-e-porque-passei-a-escrever-com-teclado-dvorak). Então, resolvi filmar e comparar a digitação. No Qwerty, os dedos dançam desordenadamente por todas as direções, como tentáculos com vida própria; isso faz sentido se pensarmos que a disposição das teclas é aleatória, apenas afastada para que os tipos das máquinas de escrever não se enroscassem — é espontâneo como as línguas naturais. O Dvorak tem um ritmo linear, previsível como o falar regular de uma língua planejada feito o Esperanto.

<video width="100%" controls poster="/img/blog/dvorak-e-qwerty.png">
 <source src="/img/blog/dvorak-e-qwerty.mp4" type="video/mp4" alt="Sequência de escrita alternando entre os leiautes de teclado Qwerty e Dvorak." title="Entre Qwerty e Dvorak.">  
...
[^1]: BUZING, Pieter C. **Comparing Different Keyboard Layouts: Aspects of QWERTY, DVORAK and alphabetical keyboards**. Amsterdam: Universidade de Vrije–Departamento de Inteligência Artificial, 2003. Disponível em: < https://www.researchgate.net/profile/Pieter-Buzing/publication/252214871_Comparing_Different_Keyboard_Layouts_Aspects_of_QWERTY_DVORAK_and_alphabetical_keyboards/links/60c3123c4585157774c7fd96/Comparing-Different-Keyboard-Layouts-Aspects-of-QWERTY-DVORAK-and-alphabetical-keyboards.pdf >. Acesso: 25 maio 2026.

[^2]: CHO, Hanggjun. **Comparing QWERTY and Dvorak Keyboard Speed: a Pilot Study**. Seul: Universidade Nacional de Seul–Departamento de Engenharia Elétrica e Ciência da Computação, 2014. Disponível em: < https://s-space.snu.ac.kr/handle/10371/123098?mode=simple >. Acesso: 26 maio 2026.

[^3]: CALDEIRA, Ari. **Ótimas novidades!** Sorocaba: Fórum Nando Florestan, 14 jul. 2005. Disponível em: < http://web.archive.org/web/20060528165641if_/http://oui.com.br/n/forum_viewtopic.php?2.117 >. Acesso: 25 maio 2026.
